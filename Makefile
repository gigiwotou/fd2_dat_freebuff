...
GAME_SRCS = $(SRC_DIR)/fd2_input.c $(SRC_DIR)/fd2_render.c $(SRC_DIR)/fd2_audio.c $(SRC_DIR)/fd2_resources.c $(SRC_DIR)/fd2_afm.c $(SRC_DIR)/fd2_scene.c $(SRC_DIR)/fd2_game_core.c $(SRC_DIR)/fd2_map_loader.c $(SRC_DIR)/fd2_icon_b24.c $(SRC_DIR)/fd2_sprite.c $(SRC_DIR)/main.c $(SRC_DIR)/fd2_states.c $(SRC_DIR)/fd2_states_intro.c $(SRC_DIR)/fd2_menu.c $(SRC_DIR)/fd2_battle.c $(SRC_DIR)/fd2_battle_sprite.c $(SRC_DIR)/fd2_battle_cursor.c $(SRC_DIR)/fd2_battle_menu.c $(SRC_DIR)/fd2_save_load.c $(SRC_DIR)/fd2_continue.c $(SRC_DIR)/fd2_cutscene.c
GAME_OBJS = $(OBJ_DIR)/fd2_input.o $(OBJ_DIR)/fd2_render.o $(OBJ_DIR)/fd2_audio.o $(OBJ_DIR)/fd2_resources.o $(OBJ_DIR)/fd2_afm.o $(OBJ_DIR)/fd2_scene.o $(OBJ_DIR)/fd2_game_core.o $(OBJ_DIR)/fd2_map_loader.o $(OBJ_DIR)/fd2_icon_b24.o $(OBJ_DIR)/fd2_sprite.o $(OBJ_DIR)/main.o $(OBJ_DIR)/fd2_states.o $(OBJ_DIR)/fd2_states_intro.o $(OBJ_DIR)/fd2_menu.o $(OBJ_DIR)/fd2_battle.o $(OBJ_DIR)/fd2_battle_sprite.o $(OBJ_DIR)/fd2_battle_cursor.o $(OBJ_DIR)/fd2_battle_menu.o $(OBJ_DIR)/fd2_save_load.o $(OBJ_DIR)/fd2_continue.o $(OBJ_DIR)/fd2_cutscene.o
GAME_RELEASE_OBJS = $(OBJ_RELEASE_DIR)/fd2_input.o $(OBJ_RELEASE_DIR)/fd2_render.o $(OBJ_RELEASE_DIR)/fd2_audio.o $(OBJ_RELEASE_DIR)/fd2_resources.o $(OBJ_RELEASE_DIR)/fd2_afm.o $(OBJ_RELEASE_DIR)/fd2_scene.o $(OBJ_RELEASE_DIR)/fd2_game_core.o $(OBJ_RELEASE_DIR)/fd2_map_loader.o $(OBJ_RELEASE_DIR)/fd2_icon_b24.o $(OBJ_RELEASE_DIR)/fd2_sprite.o $(OBJ_RELEASE_DIR)/main.o $(OBJ_RELEASE_DIR)/fd2_states.o $(OBJ_RELEASE_DIR)/fd2_states_intro.o $(OBJ_RELEASE_DIR)/fd2_menu.o $(OBJ_RELEASE_DIR)/fd2_battle.o $(OBJ_RELEASE_DIR)/fd2_battle_sprite.o $(OBJ_RELEASE_DIR)/fd2_battle_cursor.o $(OBJ_RELEASE_DIR)/fd2_battle_menu.o $(OBJ_RELEASE_DIR)/fd2_save_load.o $(OBJ_RELEASE_DIR)/fd2_continue.o $(OBJ_RELEASE_DIR)/fd2_cutscene.o
