...
DECODER_OBJS = $(OBJ_DIR)/fd2_decoder.o $(OBJ_DIR)/fd2_rle.o $(OBJ_DIR)/fd2_dat_loader.o
DECODER_RELEASE_OBJS = $(OBJ_RELEASE_DIR)/fd2_decoder.o $(OBJ_RELEASE_DIR)/fd2_rle.o $(OBJ_RELEASE_DIR)/fd2_dat_loader.o
