...
GAME_SRCS = $(SRC_DIR)/fd2_input.c $(SRC_DIR)/fd2_render.c $(SRC_DIR)/fd2_audio.c $(SRC_DIR)/fd2_resources.c $(SRC_DIR)/fd2_afm.c $(SRC_DIR)/fd2_map_loader.c $(SRC_DIR)/fd2_icon_b24.c $(SRC_DIR)/fd2_sprite.c $(SRC_DIR)/main.c $(SRC_DIR)/fd2_save_load.c $(SRC_DIR)/fd2_state_machine.c $(SRC_DIR)/fd2_scenes.c $(SRC_DIR)/fd2_globals.c $(SRC_DIR)/fd2_data_loader.c $(SRC_DIR)/fd2_scene_interact.c $(SRC_DIR)/fd2_input_scan.c $(SRC_DIR)/fd2_render_pipeline.c $(SRC_DIR)/fd2_rle.c $(SRC_DIR)/fd2_opening_animation.c $(SRC_DIR)/fd2_scene_manager.c
GAME_OBJS = $(OBJ_DIR)/fd2_input.o $(OBJ_DIR)/fd2_render.o $(OBJ_DIR)/fd2_audio.o $(OBJ_DIR)/fd2_resources.o $(OBJ_DIR)/fd2_afm.o $(OBJ_DIR)/fd2_map_loader.o $(OBJ_DIR)/fd2_icon_b24.o $(OBJ_DIR)/fd2_sprite.o $(OBJ_DIR)/main.o $(OBJ_DIR)/fd2_save_load.o $(OBJ_DIR)/fd2_state_machine.o $(OBJ_DIR)/fd2_scenes.o $(OBJ_DIR)/fd2_globals.o $(OBJ_DIR)/fd2_data_loader.o $(OBJ_DIR)/fd2_scene_interact.o $(OBJ_DIR)/fd2_input_scan.o $(OBJ_DIR)/fd2_render_pipeline.o $(OBJ_DIR)/fd2_rle.o $(OBJ_DIR)/fd2_opening_animation.o $(OBJ_DIR)/fd2_scene_manager.o
GAME_RELEASE_OBJS = $(OBJ_RELEASE_DIR)/fd2_input.o $(OBJ_RELEASE_DIR)/fd2_render.o $(OBJ_RELEASE_DIR)/fd2_audio.o $(OBJ_RELEASE_DIR)/fd2_resources.o $(OBJ_RELEASE_DIR)/fd2_afm.o $(OBJ_RELEASE_DIR)/fd2_map_loader.o $(OBJ_RELEASE_DIR)/fd2_icon_b24.o $(OBJ_RELEASE_DIR)/fd2_sprite.o $(OBJ_RELEASE_DIR)/main.o $(OBJ_RELEASE_DIR)/fd2_save_load.o $(OBJ_RELEASE_DIR)/fd2_state_machine.o $(OBJ_RELEASE_DIR)/fd2_scenes.o $(OBJ_RELEASE_DIR)/fd2_globals.o $(OBJ_RELEASE_DIR)/fd2_data_loader.o $(OBJ_RELEASE_DIR)/fd2_scene_interact.o $(OBJ_RELEASE_DIR)/fd2_input_scan.o $(OBJ_RELEASE_DIR)/fd2_render_pipeline.o $(OBJ_RELEASE_DIR)/fd2_rle.o $(OBJ_RELEASE_DIR)/fd2_opening_animation.o $(OBJ_RELEASE_DIR)/fd2_scene_manager.o
