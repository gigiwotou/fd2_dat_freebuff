...
# Source files
DECODER_SRCS = $(SRC_DIR)/fd2_decoder.c $(SRC_DIR)/fd2_rle.c $(SRC_DIR)/fd2_dat_loader.c
DECODER_OBJS = $(OBJ_DIR)/fd2_decoder.o $(OBJ_DIR)/fd2_rle.o $(OBJ_DIR)/fd2_dat_loader.o $(OBJ_DIR)/fd2_lmi1.o $(OBJ_DIR)/fd2_figani.o
DECODER_RELEASE_OBJS = $(OBJ_RELEASE_DIR)/fd2_decoder.o $(OBJ_RELEASE_DIR)/fd2_rle.o $(OBJ_RELEASE_DIR)/fd2_dat_loader.o $(OBJ_RELEASE_DIR)/fd2_lmi1.o $(OBJ_RELEASE_DIR)/fd2_figani.o

GAME_SRCS = $(SRC_DIR)/fd2_rle.c $(SRC_DIR)/fd2_dat_loader.c $(SRC_DIR)/fd2_input.c $(SRC_DIR)/fd2_render.c $(SRC_DIR)/fd2_audio.c $(SRC_DIR)/fd2_resources.c $(SRC_DIR)/fd2_afm.c $(SRC_DIR)/fd2_scene.c $(SRC_DIR)/fd2_game_core.c $(SRC_DIR)/fd2_map_loader.c $(SRC_DIR)/fd2_icon_b24.c $(SRC_DIR)/fd2_sprite.c $(SRC_DIR)/main.c $(SRC_DIR)/fd2_states.c $(SRC_DIR)/fd2_states_intro.c $(SRC_DIR)/fd2_menu.c $(SRC_DIR)/fd2_battle.c $(SRC_DIR)/fd2_battle_sprite.c $(SRC_DIR)/fd2_battle_cursor.c $(SRC_DIR)/fd2_battle_menu.c $(SRC_DIR)/fd2_battle_terrain_info.c $(SRC_DIR)/fd2_battle_core.c $(SRC_DIR)/fd2_battle_info.c $(SRC_DIR)/fd2_battle_turn.c $(SRC_DIR)/fd2_save_load.c $(SRC_DIR)/fd2_continue.c $(SRC_DIR)/fd2_cutscene.c
