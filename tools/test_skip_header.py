...
def test_skip_header(icon_data, width, height, pal_window):
    """跳过前4字节（宽高头）后解码"""
    global ec66_ah, ec66_prev_al, ec66_src_pos
...
def main():
    ...
    for icon_idx in range(min(5, len(icon_offsets))):
        ...
        pixels = test_skip_header(icon_data, outer_w, outer_h, pal_win)
        ...
        output_path = f'output/icon1_skip_header_{icon_idx}.png'
