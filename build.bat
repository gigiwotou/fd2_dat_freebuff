...
:: Object files (debug)
set DECODER_OBJ=%OBJ_DIR%\fd2_decoder.o %OBJ_DIR%\fd2_rle.o
...
set DECODER_RELEASE_OBJ=%OBJ_RELEASE_DIR%\fd2_decoder.o %OBJ_RELEASE_DIR%\fd2_rle.o
...
if "%TARGET%"=="all" (
    call :compile %SRC_DIR%\fd2_decoder.c %OBJ_DIR%\fd2_decoder.o
    ...
    if errorlevel 1 goto :error
    call :compile %SRC_DIR%\fd2_battle_core.c %OBJ_DIR%\fd2_battle_core.o
    if errorlevel 1 goto :error
    call :compile %SRC_DIR%\fd2_battle_info.c %OBJ_DIR%\fd2_battle_info.o
    if errorlevel 1 goto :error
    call :compile %SRC_DIR%\fd2_battle_turn.c %OBJ_DIR%\fd2_battle_turn.o
    if errorlevel 1 goto :error
...
:build_release
call :compile_release %SRC_DIR%\fd2_decoder.c %OBJ_RELEASE_DIR%\fd2_decoder.o
if errorlevel 1 goto :error
...
if errorlevel 1 goto :error
call :compile_release %SRC_DIR%\fd2_battle_core.c %OBJ_RELEASE_DIR%\fd2_battle_core.o
if errorlevel 1 goto :error
call :compile_release %SRC_DIR%\fd2_battle_info.c %OBJ_RELEASE_DIR%\fd2_battle_info.o
if errorlevel 1 goto :error
